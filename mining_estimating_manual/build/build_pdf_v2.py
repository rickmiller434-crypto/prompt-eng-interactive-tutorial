...
& Rate Library (RMM-CIVIL-CANADA-2026-MANUAL-REV2.pdf) directly via
...
OUT = os.path.join(os.path.dirname(__file__), "..", "RMM-CIVIL-CANADA-2026-MANUAL-REV2.pdf")
...
DOC_NUMBER = "RMM-CIVIL-CANADA-2026-MANUAL-REV2"
...
control_rows = [
    ...
    ("REVISION",               "Rev 2 — End-to-End Mining Civil + Real Market Benchmark"),
...
story.append(Paragraph(f"{DOC_NUMBER} | Rev 2 — End-to-End + Real Market Benchmark | Q2-2026", small_style))
