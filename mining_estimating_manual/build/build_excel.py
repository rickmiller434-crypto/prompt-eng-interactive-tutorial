"""
Build the consolidated contractor-grade Mining Heavy Civil Estimating Manual
Excel rate library / bid support workbook (RMM-CIVIL-CANADA-2026-MANUAL-REV1).

Baseline data is taken verbatim from the two source workbooks the author
provided (Rev G "CONTRACTOR BID TOOL" and Rev E "EPCM BENCHMARK ESTIMATOR").
Framework / template sections (constructability, exclusions register, bid
leveling, change pricing, project roll-up, unit rate build-up calculator) are
explicitly labelled [TEMPLATE - populate per project] so the source of every
cell is obvious.
"""
...
OUT = os.path.join(os.path.dirname(__file__), "..", "RMM-CIVIL-CANADA-2026-MANUAL-REV1.xlsx")
...
SUBTITLE = "Consolidated Schedule of Rates, Bid Support Package & Estimating Standard | AACE 18R-97 Class 3 baseline | Canada-wide Q2-2026 | All figures CAD"
