...
Estimating Manual & Rate Library (RMM-CIVIL-CANADA-2026-MANUAL-REV1).
...
OUT = os.path.join(os.path.dirname(__file__), "..", "RMM-CIVIL-CANADA-2026-MANUAL-REV1.docx")
...
doc.add_paragraph("\n\n")
control_rows = [
    ("DOCUMENT NUMBER",        "RMM-CIVIL-CANADA-2026-MANUAL-REV1"),
...
p = doc.add_paragraph()
p.alignment = WD_ALIGN_PARAGRAPH.CENTER
run = p.add_run(f"\n{ 'RMM-CIVIL-CANADA-2026-MANUAL-REV1' } | Rev 1 — Consolidated | Q2-2026")
