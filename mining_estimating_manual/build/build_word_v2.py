...
Estimating Manual & Rate Library (RMM-CIVIL-CANADA-2026-MANUAL-REV2).
...
OUT = os.path.join(os.path.dirname(__file__), "..", "RMM-CIVIL-CANADA-2026-MANUAL-REV2.docx")
...
doc.add_paragraph("\n\n")
control_rows = [
    ("DOCUMENT NUMBER",        "RMM-CIVIL-CANADA-2026-MANUAL-REV2"),
...
p = doc.add_paragraph()
p.alignment = WD_ALIGN_PARAGRAPH.CENTER
run = p.add_run(f"\n{ 'RMM-CIVIL-CANADA-2026-MANUAL-REV2' } | Rev 2 — End-to-End + Real Market Benchmark | Q2-2026")
