...
Manual & Rate Library (RMM-CIVIL-CANADA-2026-MANUAL-REV2).
...
OUT = os.path.join(os.path.dirname(__file__), "..", "RMM-CIVIL-CANADA-2026-MANUAL-REV2.xlsx")
...
SUBTITLE = ("Rev 2 — End-to-End Mining Heavy Civil | Consolidated SoR + Real Market Benchmark Cross-Reference | "
