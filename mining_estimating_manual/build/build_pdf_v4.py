...
& Rate Library (RMM-CIVIL-CANADA-2026-MANUAL-REV4.pdf) directly via
...
OUT = os.path.join(os.path.dirname(__file__), "..", "RMM-CIVIL-CANADA-2026-MANUAL-REV4.pdf")
...
story.append(Paragraph(f"{DOC_NUMBER} | Rev 4 — Full Build-Up Reconciliation + Audit Highlights | Q2-2026", small_style))
