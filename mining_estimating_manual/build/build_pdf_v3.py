...
& Rate Library (RMM-CIVIL-CANADA-2026-MANUAL-REV3.pdf) directly via
...
OUT = os.path.join(os.path.dirname(__file__), "..", "RMM-CIVIL-CANADA-2026-MANUAL-REV3.pdf")
...
DOC_NUMBER = "RMM-CIVIL-CANADA-2026-MANUAL-REV3"
...
story.append(Paragraph(f"{DOC_NUMBER} | Rev 3 — End-to-End + Build-Up + Restored Items | Q2-2026", small_style))
